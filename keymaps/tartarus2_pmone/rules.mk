...
# No CDC: its interface-association and union functional descriptors embed
# interface numbers internally, which the PowerMic-mode splice would have to
# rewrite as well. Nothing here uses a serial port, and dropping it makes
# PowerMic mode exactly the kbd/mouse/PowerMic shape that PowerScribe accepts.
VIRTSER_ENABLE = no
