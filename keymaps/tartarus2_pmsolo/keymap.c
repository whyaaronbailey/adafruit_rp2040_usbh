...
#ifdef VIA_ENABLE  // bench opcodes ride VIA raw HID; absent in the PowerScribe-only build
...
#ifdef VIA_ENABLE  // VIA dynamic macros
...
#ifdef VIA_ENABLE  // only the VIA lighting menu saves settings
...
#ifdef VIA_ENABLE  // VIA "Lighting" menu handler
